...
class SearchUserNotifier extends StateNotifier<AsyncValue<List<UserModel>>> {
  ...
  SearchUserNotifier(this.ref) : super(const AsyncValue.data([]));
  ...
  Future<void> search(String keyword) async {
    ...
    try {
      final users =
          await ref.read(apiGetSearchMasterUser).get(keyword: keyword);
