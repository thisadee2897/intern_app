...
//             actions: [
//               TextButton(child: const Text('ยกเลิก'), onPressed: () => Navigator.of(ctx).pop(false)),
//               ElevatedButton(
...
//         Navigator.of(context).pop(true);
//         ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('✅ ลบโปรเจกต์เรียบร้อยแล้ว')));
//       } catch (e) {
//         if (!mounted) return;

//         ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('❌ ล้มเหลว: ${e.toString()}')));
//       }
//     }
//   }
...
//                     width: 48,
//                     height: 48,
//                     child: IconButton(tooltip: 'ลบโปรเจกต์', icon: const Icon(Icons.delete, color: Colors.redAccent), onPressed: _confirmDelete),
//                   ),
//                 ),
//               ],
//             ),
