...
import 'package:project/models/user_model.dart'; // ✅ เพิ่มตรงนี้

part 'et_task_model.freezed.dart';
part 'et_task_model.g.dart';

@freezed
class GetTaskModel with _$GetTaskModel {
  const factory GetTaskModel({
    ...
    @JsonKey(name: 'created_by') UserModel? createdBy, // ✅ แก้ตรงนี้
    @JsonKey(name: 'updated_by') UserModel? updatedBy, // ✅ แก้ตรงนี้
